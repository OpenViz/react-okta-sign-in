import { CREATE_AUTH, LOGIN_AUTH_SUCCESS, LOGIN_AUTH_ERROR, REFRESH_SESSION_SUCCESS, REFRESH_SESSION_ERROR, CLOSE_SESSION_SUCCESS, CLOSE_SESSION_ERROR } from '../actions/index';

const INITIAL_STATE = { active: false, sessionObject: null };
